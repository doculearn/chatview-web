...
const BILLBOARDS: Billboard[] = [
  {
    ...
    title: (
      <>
        Run <span className="text-(--accent)">Claude Code, Codex CLI & Cursor</span> from your phone.
      </>
    ),
    description:
    ...
    highlights: [
      { title: "Bring your own CLI", description: "Claude Code, Codex CLI, Aider, Cline/Roo, or anything else you can run in a terminal." },
...
const STEPS = [
  ...
  { n: 3, title: "Pick your agent", body: "Claude Code, Codex CLI, Cursor Agent, Copilot Chat — whatever you already pay for." },
          ...
          <div className="glass-panel feature-card-spotlight rounded-2xl p-6 sm:p-8">
            ...
            <ul className="mt-6 space-y-2 text-sm">
              {[
                ...
                "Works with Claude Code, Codex CLI, Cursor, Copilot",
