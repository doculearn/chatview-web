...
const DESCRIPTION =
  "ChatView is Codex Mobile for Claude Code, Codex, Cursor & VS Code — built by one indie hacker. Tip $5, $10 or $20 to fund servers, features and late-night commits.";
